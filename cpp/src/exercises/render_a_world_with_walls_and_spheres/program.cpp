...
int main()
{
	...
	auto c = camera(600, 300, M_PI / 3, transformations::getViewTransform(
	...
	image_formats::file_utility::overwrite("./cpp/src/exercises/render_a_world_with_walls_and_spheres/render_a_world_with_walls_and_spheres.ppm", ppm);
